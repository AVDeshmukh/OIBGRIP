...
class OnlineTest extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getActionCommand().equals("Submit"))
		{
			...
			current++;
			l.setVisible(false);
			long tm=star-System.nanoTime();
			A=new Result(count,tm);
	...
	void set()
	{
		...
		if(current==1)
		{
			...
			jb[0].setText("32 and 64");jb[1].setText("32 and 32");jb[2].setText("64 and 64");jb[3].setText("32 and 32");
		}
		if(current==2)
		{
	...
	public static void checkTime(long st)
	{
	...
	{
		new OnlineTest("Online Test Of Java",1);
	}
